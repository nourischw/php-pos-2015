<div class="modal fade popup_list" id="deposit_popup_list" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog" style="width: 1000px">
        <div class="modal-content">
            <div class="modal-header" style="border: 0px; height: 45px; padding-top: 10px; padding-bottom: 0px;">
                <span class="page_title">Deposit List</span>
                <img src="{{ Config::get('path.IMAGES') }}close_button.png" class="close_popup_button" />
            </div>
			
			<div class="modal-body">
				<div class="search_block">
					<form id="form_deposit_popup_list" class="popup_list_search_form" data-list_id="deposit_popup_list">
						<div class="form_row">
							<label class="form_label">Deposit Number:</label>
							<div class="fL form_field"><input type="text" id="search_deposit_number" name="search_deposit_number" class="form-control text_field" /></div>
				...
				<div id="item_list" class="item_list">
					<div class="list_header">
						<span class="list_column col_deposit_number">Deposit No.</span>
						<span class="list_column col_deposit_date">Date</span>
						<span class="list_column col_deposit_terms">Terms</span>
						...
						<span class="list_column col_amount">Sub Total Amt</span>
            ...
            <div class="modal-footer" style="border: 0px;">
				<div class="list_pagination">
					...
					<div class="paging_bar_column">
						<ul class="pagination pagination-sm list_pagination_bar" id="page_bar" data-list_id="deposit_popup_list"></ul>
					</div>
				</div>
            </div>
