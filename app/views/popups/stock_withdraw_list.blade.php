<div class="modal fade popup_list" id="stock_withdraw_popup_list" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
			...
			<div class="modal-body">
				<div class="search_block">
					<form id="form_stock_withdraw_popup_list" class="popup_list_search_form" data-list_id="stock_withdraw_popup_list">
						<div class="form_row">
                            <label class="form_label">Supplier:</label>
                            <div class="fL form_field" id="popup_supplier_name_text">---</div>
						</div>
						<div class="form_row">
							<label class="form_label">GI Code:</label>
							<div class="fL form_field"><input type="text" id="search_product_upc" name="search_gi_code" class="form-control text_field" /></div>
							...
							<input type="hidden" name="search_supplier_id" id="search_supplier_id" />
						</div>
					</form>
				</div>
				...
				<div id="item_list" class="item_list">
					<div class="list_header">
						...
						<span class="list_column col_unit_price">Actual Price</span>
					</div>
            ...
            <div class="modal-footer" style="border: 0px;">
				<div class="list_pagination">
					...
					<div class="paging_bar_column">
						<ul class="pagination pagination-sm list_pagination_bar" id="page_bar" data-list_id="stock_withdraw_popup_list"></ul>
					</div>
				</div>
            </div>
