...
<table border="0" width="990" cellpadding="0" style="font-family: Helvetica; line-height: 18px; border-top: 1px solid black">
    ...
    <tr>
        ...
        <td width="65" style="text-align: right;">${{ $net_total_amount }}</td>
        <td width="160"></td>
	...
	<tr>
        ...
        <td width="45">(HKD)</td>
        <td width="90" style="text-align: right;">-${{ $deposit_payment_amount }}</td>		
    </tr>

    <tr>
        <td colspan="6"></td>
        <td width="70" style="font-family: msungstdlight">全單折扣:</td>
        <td width="45"></td>
        <td width="90" style="text-align: right;">{{ $discount }}</td>		
    </tr>
	
    <tr>
        <td colspan="6"></td>
        <td width="70" style="font-family: msungstdlight">收取金額:</td>
        <td width="45">(HKD)</td>
        <td width="90" style="text-align: right;">${{ $net_total_amount }}</td>
    </tr>

    <tr>
        <td></td>
        <td colspan="5" style="font-family: msungstdlight">如手機不能開啓, 不接受7天新機換機服務。</td>
        <td colspan="3" style="text-align: right;">C. O. D.</td>
    </tr>

    <tr>
        <td colspan="9" style="text-align: right;">CASH: {{ $net_total_amount }}</td>
    </tr>
</table>

<table border="0" width="1000" cellpadding="0" style="font-family: Helvetica;">
    <tr><td colspan="9" style="line-height: 15px;"></td></tr>
    ...
    <tr>
        <td width="300" style="font-size: small; line-height: 9px;">
            ...
            <span style="font-family: msungstdlight">請保留此單據作為維修及更換手機服務之用<br />
            客戶服務熱線 Customer Service Hotline: (852) 8203 3166</span>
        </td>
        <td width="340" style="line-height: 11px; text-align: right;">
            <span style="font-family: msungstdlight">如手機不能開啟，不接受7天新機換機服務。<br />
            No defective trade-in during the 7 days of purchase<br />
            guarantees if Handset could on power-on.<br /></span>
