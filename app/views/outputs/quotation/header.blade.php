...
<table border="0" cellpadding="0">
    <tr>
        <td rowspan="3" width="150" style="font-size: xx-large"></td>
        ...
        <td rowspan="3" width="200">
            <table style="border: 1px solid black">
                ...
                <tr>
                    ...
                    <td width="120" style="font-family: Helvetica;"><strong>{{ $quotation_number }}</strong></td>
                </tr>
                <tr>
                    <td width="5"></td>
...
<table style="border: 1px solid black; font-size: small" height="400" cellpadding="0">
    <tr bgcolor="#CCC" style="line-height: 20px; font-family: Helvetica; font-size: small; font-weight: bold;">
        <td width="30" style="border-left: 1px solid black; border-top: 1px solid black; border-right: 1px solid black;"></td>
        <td width="5" style="border-top: 1px solid black;"></td>
        <td width="376" style="border-top: 1px solid black; border-right: 1px solid black;">DESCRIPTION</td>
        <td width="5" style="border-top: 1px solid black;"></td>
    ...
    <tr>
        <td height="700" style="border-left: 1px solid black; border-top: 1px solid black; border-right: 1px solid black;"></td>
