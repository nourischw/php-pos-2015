...
<table border="0" width="990" cellpadding="0" style="font-family: Helvetica, msungstdlight;">
    ...
    <tr>
        <td width="640"><table>
            <tr>
                <td width="5"></td>
                <td width="280" colspan="2" style="font-family: msungstdlight;">{{ $P_DETAIL }}</td>
                <td width="100">{{ $serial_number }}</td>
                <td width="40" style="text-align: right;">{{ $qty }}</td>
                <td width="70" style="text-align: right;">${{ $unit_price }}</td>
                <td width="60" style="text-align: right;">{{ $order_discount_text }}</td>
        ...
        <td width="340"><table><tr>
            <td width="90">{{ $P_DETAIL }}</td>
            <td width="10"></td>
            <td width="85">{{ $serial_number }}</td>
